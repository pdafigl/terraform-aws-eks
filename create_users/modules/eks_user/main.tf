...
resource "aws_iam_policy_attachment" "terraform_eks_user_attachment" {
  name       = "eks_user-attachment"
  users      = [aws_iam_user.terraform_eks_user.name]
